module.exports = /******/ (() => {
    ...
    /******/ var __webpack_modules__ = {
        /***/ 278: /***/ (
             ...
             * @license MIT
             */
            const { OPERATOR } = __webpack_require__(613);
            /**
             * @lends ParserData
             * @class
             */
        ...
        /***/ 106: /***/ (
             ...
             * @license MIT
             */
            const { Operand } = __webpack_require__(278),
                { SERVICE } = __webpack_require__(613),
                { NativeFunctionExcecutionError } = __webpack_require__(435),
                { iPoonyaObject, iPoonyaPrototype } = __webpack_require__(36);
            /**
            ...
            class NativeFunction {
                ...
                result(
                    ...
                    try {
                        ...
                        throw_error(
                            call_pos,
                            new NativeFunctionExcecutionError(
                                this.target.name,
                                e.stack
                            )
                        );
        ...
        /***/ 26: /***/ (
             ...
             * @license MIT
             */
            const { FIELDFLAGS } = __webpack_require__(613),
                PoonyaObject = __webpack_require__(591),
                NativeFunction = __webpack_require__(106);
            /**
             * @lends PoonyaArray
             * @class
             */
        ...
        /***/ 990: /***/ (
             ...
             * @license MIT
             */
            const PoonyaObject = __webpack_require__(591);
            /**
             * @lends PoonyaBoolean
             * @class
             */
        ...
        /***/ 591: /***/ (
            ...
            const {
                ...
                { iContext } = __webpack_require__(36),
                { SUPER_CALL, GET, FIELDFLAGS, CONFIG } = __webpack_require__(
                    613
                ),
                { Cast } = __webpack_require__(390),
                { iPoonyaObject, iPoonyaPrototype } = __webpack_require__(36),
                NativeFunction = __webpack_require__(106);
            /**
             * @lends PoonyaObject
        ...
        /***/ 735: /***/ (
            ...
            const { IS, GET, FIELDFLAGS, SUPER_CALL } = __webpack_require__(
                ...
                { iPoonyaPrototype } = __webpack_require__(36),
                { Cast } = __webpack_require__(390);
            /**
        ...
        /***/ 413: /***/ (
             ...
             * @license MIT
             */
            const { Operand, Operator } = __webpack_require__(278),
                { CHARTYPE, OPERATOR, SERVICE } = __webpack_require__(613),
                {
                    UnableToRecognizeTypeException,
                    TheSequenceException,
                } = __webpack_require__(435),
                { Cast } = __webpack_require__(390),
                ObjectContructorCall = __webpack_require__(955);
            /**
            ...
            class ExpressionGroup extends Operand {
                ...
                append(entry, throw_error) {
                    ...
                    if (
                        ...
                        throw_error(
                            entry.position,
                            new TheSequenceException(entry)
                        );
        ...
        /***/ 566: /***/ (
             ...
             */
            const { Operand } = __webpack_require__(278),
                { SERVICE, FIELDFLAGS } = __webpack_require__(613),
                NativeFunction = __webpack_require__(106);
            /**
             * @lends GetOperator
             * @protected
        ...
        /***/ 274: /***/ (
             ...
             * @license MIT
             */
            const ExpressionGroup = __webpack_require__(413),
                {
                    TheFieldMustBeAnArrayInstanceExceprion,
                    GetFieldOfNullException,
                } = __webpack_require__(435),
                PoonyaArray = __webpack_require__(26),
                PoonyaObject = __webpack_require__(591);
            /**
             * @lends PushOperator
             * @protected
        ...
        /***/ 442: /***/ (
             ...
             * @license MIT
             */
            const { TheFieldMustBeNumberException } = __webpack_require__(435),
                PoonyaNumber = __webpack_require__(567);
            /**
        ...
        /***/ 369: /***/ (
             ...
             */
            const ExpressionGroup = __webpack_require__(413),
                { iPoonyaObject } = __webpack_require__(36),
                {
        ...
        /***/ 435: /***/ (
             ...
             * @license MIT
             */
            const { SERVICE } = __webpack_require__(613),
            ...
            class TheSequenceException extends PoonyaException {
                constructor(entry) {
                    super(
                        `Wrong order: condition operator: '${entry.toString()}'`
                    );
                }
            }
            /**
        ...
        /***/ 613: /***/ (
             ...
             * @author Astecom
             */
            const { dirname } = __webpack_require__(622); // Защищенные поля для PoonyaPrototype
        ...
        /***/ 102: /***/ (
            ...
            const {
                ...
                { GET, SERVICE, IS } = __webpack_require__(613),
                { Cast } = __webpack_require__(390),
                { iContext, iPoonyaPrototype } = __webpack_require__(36),
                { PoonyaStaticLibrary } = __webpack_require__(30),
                ExpressionGroup = __webpack_require__(413),
                PoonyaObject = __webpack_require__(591),
                PoonyaArray = __webpack_require__(26),
                PoonyaInteger = __webpack_require__(383),
                PoonyaNumber = __webpack_require__(567),
                PoonyaString = __webpack_require__(200),
                PoonyaBoolean = __webpack_require__(990),
                PoonyaNull = __webpack_require__(426);
            /**
             * @lends Heap
             * @class
             */
        ...
        /***/ 30: /***/ (
            ...
            const Module = __webpack_require__(282),
                { readdirSync, readFileSync } = __webpack_require__(747),
                { join, normalize, resolve } = __webpack_require__(622),
                { NAMESPACE, SERVICE, FIELDFLAGS } = __webpack_require__(613),
                PoonyaObject = __webpack_require__(591),
                NativeFunction = __webpack_require__(106),
                PoonyaPrototype = __webpack_require__(735);
            /**
            ...
            class PoonyaModule extends Module {
                ...
                require(id) {
                    if (id === "poonya") {
                        ...
                        exports.Exceptions = __webpack_require__(435);
            ...
            (() => {
                ...
                ImportDir = (parent_path, lib_dir) => {
                    ...
                    for (
                        let i = 0, leng = default_libs.length, cur, path;
                        i < leng;
                        i++
                    ) {
                        cur = new PoonyaModule(default_libs[i]);
                        ...
                        cur._compile(
                            `"use strict";${readFileSync(path, "utf-8")};`,
                            path
                        );
                    }
                };
        ...
        /***/ 694: /***/ (
             ...
             * @author Astecom
             */
            const { CHARTYPE } = __webpack_require__(613);
            /**
             * @lends LexerEntry
             * @class
             */
        ...
        /***/ 205: /***/ (
             ...
             */
            const { CHARTYPE } = __webpack_require__(613),
                LexerEntry = __webpack_require__(694);
            /**
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (allow_spaces || last !== CHARTYPE.SPACE)
                                Export.push(
                                    new LexerEntry(last, buff, i, string_entry)
                                );
                            string_entry = null;
        ...
        /***/ 900: /***/ (
            ...
            const { readFile } = __webpack_require__(747),
                ...
                { maybeEquals } = __webpack_require__(390),
                { CHARTYPE } = __webpack_require__(613),
                { IOError } = __webpack_require__(435),
                lexer = __webpack_require__(205);
            /**
        ...
        /***/ 80: /***/ (
            ...
            const {
                ...
                { maybeEquals, countKeys } = __webpack_require__(390),
                { CHARTYPE, SERVICE } = __webpack_require__(613),
                FunctionCall = __webpack_require__(847),
                ObjectContructorCall = __webpack_require__(955),
                TernarOperator = __webpack_require__(945),
                ExpressionGroup = __webpack_require__(413),
                GetOperator = __webpack_require__(566),
                IfStatement = __webpack_require__(825),
                SequenceGroup = __webpack_require__(351),
                OutOperator = __webpack_require__(802),
                WhileStatement = __webpack_require__(475),
                RepeatStatement = __webpack_require__(442),
                SetOperator = __webpack_require__(213),
                ResetOperator = __webpack_require__(369),
                PushOperator = __webpack_require__(274),
                SequenceMainGroup = __webpack_require__(828),
                linker = __webpack_require__(900);
            /**
        ...
        /***/ 922: /***/ (
            ...
            const { EventEmitter } = __webpack_require__(614),
                ...
                { PoonyaException } = __webpack_require__(435),
                {
                    PoonyaStaticLibrary,
                    Import,
                    ImportDir,
                } = __webpack_require__(30),
                { Context, Heap } = __webpack_require__(102),
                { parser, parseExpression, parserMP } = __webpack_require__(80),
                { toFixed, toBytes } = __webpack_require__(390),
                lexer = __webpack_require__(205);
            ...
            class CodeEmitter extends EventEmitter {
                ...
                throwError(pos, message, rad_of = 5) {
                    ...
                    let buffer = [
                            message instanceof PoonyaException
                                ? message.message
                                : message,
                        ],
        ...
        /***/ 390: /***/ (
             ...
             */
            const { SERVICE } = __webpack_require__(613),
                { Operand } = __webpack_require__(278),
                { iPoonyaObject, iPoonyaPrototype } = __webpack_require__(36),
                NativeFunction = __webpack_require__(106);
            /**
